        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="/">
                        <img src="{{ asset('assets/landing-page/img/logo1.png') }}" alt="" class="w-14">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('child_data.index')" :active="request()->routeIs('child_data.*')">
                        {{ __('Data Anak') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('health_articles.index')" :active="request()->routeIs('health_articles.*')">
